...
public class EmployeeController {
    ...
    @PostMapping
    public ResponseEntity<EmployeeDTO> addEmployee(@RequestBody EmployeeDTO employeeDTO, Authentication authentication) {
        System.out.println("🔐 User: " + authentication.getName());
        System.out.println("🔐 Authorities: " + authentication.getAuthorities());
    ...
    @PreAuthorize("hasAnyRole('HR')")
    @PutMapping("/{id}")
    public ResponseEntity<EmployeeDTO> updateEmployee(@PathVariable Long id, @RequestBody EmployeeDTO updatedEmployee, Authentication authentication) {
        System.out.println("🔐 User: " + authentication.getName());
        System.out.println("🔐 Authorities: " + authentication.getAuthorities());
